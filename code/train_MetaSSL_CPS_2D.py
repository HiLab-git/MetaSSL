...
from dataloaders_CPS import utils
from dataloaders_CPS.dataset import (BaseDataSets, RandomGenerator,
                                 TwoStreamBatchSampler)
from networks.net_factory import net_factory
from utils import losses, metrics, ramps
from val_2D_CPS import test_single_volume1, test_single_volume2
...
parser.add_argument('--w_confident_label', type=float,
                    default=85, help='w_confident_label')
...
if __name__ == "__main__":
    ...
    snapshot_path = "../Meta_SSL_CPS/{}_{}/{}".format(
