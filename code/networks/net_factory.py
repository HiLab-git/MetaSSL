...
from networks.unet import UNet, UNet_DS, UNet_URPC, UNet_CCT, CCVC_UNet,MCNet2d_KD
import argparse
...
def net_factory(net_type="unet", in_chns=1, class_num=3):
    ...
    elif net_type == "ccvc_unet":
        net = CCVC_UNet(in_chns=in_chns, class_num=class_num).cuda()
    elif net_type == "MCNet2d_KD":
        net = MCNet2d_KD(in_chns=in_chns, class_num=class_num).cuda()
    elif net_type == "enet":
