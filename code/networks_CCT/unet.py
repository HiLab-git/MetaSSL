...
from .deeplab_utils import CBAM, SpatialAttention, ChannelAttention,ConvB
...
class Encoder_CCVC(nn.Module):
    def __init__(self, params):
        super(Encoder_CCVC, self).__init__()
        self.params = params
        self.in_chns = self.params['in_chns']
        self.ft_chns = self.params['feature_chns']
        self.n_class = self.params['class_num']
...
class Decoder(nn.Module):
    def __init__(self, params):
        ...
        self.up1 = UpBlock(
            self.ft_chns[4], self.ft_chns[3], self.ft_chns[3], dropout_p=0.4)
        self.up2 = UpBlock(
            self.ft_chns[3], self.ft_chns[2], self.ft_chns[2], dropout_p=0.3)
        self.up3 = UpBlock(
            self.ft_chns[2], self.ft_chns[1], self.ft_chns[1], dropout_p=0.2)
        self.up4 = UpBlock(
            self.ft_chns[1], self.ft_chns[0], self.ft_chns[0], dropout_p=0.1)
...
class CCVC_UNet(nn.Module):
    def __init__(self, in_chns, class_num):
        super(CCVC_UNet, self).__init__()
        ...
        self.encoder = Encoder_CCVC(params)
        self.decoder = Decoder(params)
        self.decoder1 = Decoder(params)
