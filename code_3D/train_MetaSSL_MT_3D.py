...
def train(args, snapshot_path):
    ...
    labeled_idxs = list(range(0, 2))
    unlabeled_idxs = list(range(2, 80))
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            with torch.no_grad():
                ...
                ema_output_soft = torch.softmax(outputs2, dim=1)
                outputs_soft2 = torch.softmax(outputs2, dim=1)
            
            loss_ce = ce_loss(outputs1[:args.labeled_bs],
            ...
            with torch.no_grad():
                ...
                cla2_true=[cla2_0_true,cla2_1_true]
            ...
            loss_diff1=loss1_po_nodifferent1 +  loss1_po_different 
            loss_diff2= loss_dif2 + pseudo_supervision_no2

            loss_same1=loss1_po_same+loss1_po_back1+loss1_po_noconfident1
            loss_same2=same_confident_loss2+pseudo_supervision_co2+pseudo_supervision_back2
            
            
            model1_loss = supervised_loss + consistency_weight*(loss_same1+loss_diff1)
            model2_loss = consistency_weight*(loss_same2+loss_diff2)
            ...
            if iter_num % 20 == 0:
                ...
                image = outputs_soft1[0, 1:2, :, :, 20:61:10].permute(
                    3, 0, 1, 2).repeat(1, 3, 1, 1)
...
if __name__ == "__main__":
    ...
    snapshot_path = "../MetaSSL_MT_3D/{}_{}/{}".format(
